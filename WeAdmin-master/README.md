...
> 跌跌撞撞又折腾过了八月，next版本终于转正为v1.6.0版本，内部优化了一些方法，优化了一些代码风格，数据调用方法等等。老朋友可以clone一份参考使用，新朋友就随意啦。实操学习，欢迎交流~

2020-08-29
WeAdmin正式定版v1.6.0
 - 统一字体图标的引用方式，优化精简代码
 - 统一左侧菜单及iframe内部打开tab菜单方法，可参考【我的桌面】-【快捷方式】-【管理员列表】
 - 新增的http方法中使用了mock数据(fastmock),可能左侧菜单打开会稍慢

2020-07-30
Layui基础版本更新
 - layui基础版本更新为V2.5.6
WeAdmin左侧菜单修改为动态获取方式
 - 新增http扩展login/menu方法,左侧菜单修改为mock请求模拟动态获取（本地JSON方式，会造成有的同学在非web环境直接打开时获取不到数据）
